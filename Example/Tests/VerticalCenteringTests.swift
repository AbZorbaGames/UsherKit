...
class VerticalCenteringTests: XCTestCase {
    ...
    func testRequiredSizeForPositioning() {
        ...
        let layout = VerticalCenteringLayout(insets: insets)
    ...
    func testCorrectPositioning() {
        ...
        let expectedResults = [
            CGRect(x: 0, y: 30, width: sizes[0].width, height: sizes[0].height),
            CGRect(x: 0, y: 35, width: sizes[1].width, height: sizes[1].height),
            CGRect(x: 0, y: 25, width: sizes[2].width, height: sizes[2].height),
            CGRect(x: 0, y: 30, width: sizes[3].width, height: sizes[3].height)
        ]
